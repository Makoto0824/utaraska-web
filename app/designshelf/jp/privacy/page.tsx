  ...
  return (
    <footer className="mt-16 bg-gray-800 py-10 text-white">
      <div className="mx-auto max-w-3xl px-4 text-center text-sm text-gray-400">
        ...
        <p className="mt-2">
          <Link href="/designshelf/jp" className="underline underline-offset-2 hover:text-white">
            Design Shelf
          </Link>
        </p>
      </div>
    ...
    <div className="rakugaki-page min-h-screen">
      ...
      <main className="mx-auto max-w-3xl px-4 py-8 sm:py-12">
        <article className="rakugaki-card rakugaki-notebook p-6 sm:p-10">
          <p className="rakugaki-badge mb-6">Design Shelf</p>
          ...
          <p className="mb-6 text-sm leading-relaxed text-slate-600 sm:text-base">
            このページでは、Design Shelf（以下「当サイト」）および「らくがきT」企画において、
          ...
          <div className="space-y-10">
            ...
            <PolicySection id="section-2" title="2. 運営者">
              <p>
                ...
                所在地、事業内容などの詳細は
                <Link href="/designshelf/jp/about" className="rakugaki-terms-link">
                  運営者情報
                </Link>
                をご確認ください。
              </p>
            ...
            <PolicySection id="section-5" title="5. らくがきT応募時の取り扱い" highlight>
              ...
              <p className="mt-4">
                応募作品の著作権や利用許諾については、
                <Link href="/designshelf/jp/rakugaki/terms" className="rakugaki-terms-link">
                  らくがきT応募規約
                </Link>
                をご確認ください。
              </p>
          ...
          <footer className="rakugaki-terms-footer mt-12 border-t border-dashed border-amber-200/60 pt-8">
            ...
            <div className="mt-8 text-center">
              <Link href="/designshelf/jp" className="rakugaki-cta-secondary inline-flex">
                Design Shelf トップへ戻る
              </Link>
            </div>
          </footer>
