      ...
      <header className="bg-white shadow-sm">
        <nav>
          <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-between gap-x-4 gap-y-2 px-4 py-4">
            <Link href="/odd" className="flex items-center shrink-0">
              <Image
            ...
            <div className="flex flex-wrap items-center justify-end gap-x-4 gap-y-2 text-sm sm:text-base sm:gap-6">
              <Link href="/odd" className="text-gray-600 hover:text-gray-900 transition-colors">
                ホーム
              </Link>
              <Link href={PICKS_PATH} className="text-gray-900 font-medium">
                Amazonおすすめ
              </Link>
              <Link href="/odd/rakugaki" className="text-gray-600 hover:text-gray-900 transition-colors">
                らくがきT
              </Link>
              <Link href="/odd/contact" className="text-gray-600 hover:text-gray-900 transition-colors">
                お問い合わせ
              </Link>
      ...
      <main className="max-w-3xl mx-auto px-3 sm:px-4 py-8 w-full min-w-0">
        <div className="bg-white rounded-lg shadow-lg p-5 sm:p-8 w-full min-w-0">
          ...
          <section className="mb-8 space-y-3 text-gray-600 leading-relaxed text-sm sm:text-base">
            <p>utaraska oddがAmazonで見つけた気になるTシャツを紹介するページです。</p>
            <p>掲載している商品はutaraska oddオリジナル商品ではありません。</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/odd/privacy" className="text-gray-300 hover:text-white transition-colors">
                    プライバシーポリシー
                  </Link>
                </li>
                <li>
                  <Link href="/odd/contact" className="text-gray-300 hover:text-white transition-colors">
                    お問い合わせ
                  </Link>
                </li>
              </ul>
