...
const KEY_POINTS = [
  ...
  '採用作品は、応募時にご記入いただいた公開用ニックネームを、サイト・SNS・商品ページ等で表示する場合があります。',
] as const;
      ...
      <nav>
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-y-3 px-4 py-4">
          ...
          <div className="flex flex-wrap items-center justify-end gap-x-4 gap-y-2 sm:gap-6">
            ...
            <Link href="/odd/rakugaki" className="font-medium text-gray-900">
              らくがきT
            </Link>
  ...
  return (
    <footer className="mt-16 bg-gray-800 py-10 text-white">
      <div className="mx-auto max-w-3xl px-4 text-center text-sm text-gray-400">
        ...
        <p className="mt-2">
          <Link href="/odd/rakugaki" className="underline underline-offset-2 hover:text-white">
            らくがきT
          </Link>
        </p>
      </div>
        ...
        <article className="rakugaki-card rakugaki-notebook p-6 sm:p-10">
          ...
          <div className="space-y-10">
            <TermsSection id="section-1" title="1. らくがきTについて">
              <p>
                らくがきTは、子どもの絵や手描きのらくがきなどを募集し、採用作品をutaraska oddのTシャツとして商品化する投稿企画です。
            ...
            <TermsSection id="section-7" title="7. 著作権と利用許諾について">
              ...
              <ul className="rakugaki-terms-list">
                ...
                <li>utaraska oddおよび当社サイトへの掲載</li>
                <li>SNS、広告、告知、実績紹介での使用（応募時にご記入いただいた公開用ニックネームでのクレジット表示を含みます）</li>
                <li>商品画像、販売ページ、バナー、サムネイル等への使用</li>
                <li>企画の運営に必要な範囲での加工、編集、複製、公開</li>
              </ul>
              <p className="mt-4 text-sm text-slate-600">
                公開用ニックネームは、本名ではなく、サイト・SNS・商品ページ等で公開してよい名前をご記入ください。
                採用作品の紹介や販売告知の際、当該ニックネームを表示する場合があります。
              </p>
              <p className="mt-4 text-sm text-slate-600">
            ...
            <TermsSection id="section-12" title="12. 個人情報の扱い">
              <p>
                応募時にいただいた氏名、公開用ニックネーム、メールアドレス、応募内容、作品画像などの情報は、らくがきT企画の運営、審査、採用連絡、謝礼送付、問い合わせ対応、採用作品の紹介・クレジット表示のために使用します。
            ...
            <TermsSection id="section-14" title="14. お問い合わせ">
              <p>
                本企画や応募規約に関するお問い合わせは、utaraska oddまたはウタラスカ合同会社の
          ...
          <footer className="rakugaki-terms-footer mt-12 border-t border-dashed border-amber-200/60 pt-8">
            ...
            <div className="mt-8 text-center">
              <Link href="/odd/rakugaki" className="rakugaki-cta-secondary inline-flex">
                規約に同意して応募ページへ戻る
              </Link>
            </div>
          </footer>
