        ...
        <nav>
          <div className="max-w-6xl mx-auto flex items-center justify-between px-4 py-4">
            ...
            <div className="flex items-center gap-6">
              <Link href="https://www.utaraska.co.jp/odd/en" className="text-gray-600 hover:text-gray-900 transition-colors">ホーム</Link>
              <Link href="/odd/en/brands" className="text-gray-600 hover:text-gray-900 transition-colors">ブランド</Link>
              <Link href="/odd/en/contact" className="text-gray-600 hover:text-gray-900 transition-colors">お問い合わせ</Link>
              <Link href="/odd/en/about" className="text-gray-600 hover:text-gray-900 transition-colors">運営者情報</Link>
            </div>
          </div>
        </nav>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-800 mb-4 border-b-2 border-gray-200 pb-2">utaraska oddについて</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              utaraska oddは、日本の伝統文化と現代アートを融合させたデザインを展開するブランドです。Amazon Merch on Demandを通じて、オリジナルデザインのグッズを販売しています。
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/odd/en/brands" className="text-gray-300 hover:text-white transition-colors">ブランド一覧</Link></li>
                <li><Link href="/odd/en/about" className="text-gray-300 hover:text-white transition-colors">運営者情報</Link></li>
                <li>
                  <Link href="/odd/en/contact" className="text-gray-300 hover:text-white transition-colors">お問い合わせ</Link>
