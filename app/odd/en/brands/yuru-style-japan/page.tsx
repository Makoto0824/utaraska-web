            ...
            {products.map((product, index) => (
              <div key={product.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:transform hover:-translate-y-1 hover:shadow-lg transition-all duration-300 w-full self-start">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <Link 
                    href={
                      product.brand === "ゆるスタイル・ジャパン" ? "/odd/en/brands/yuru-style-japan" :
                      product.brand === "ワロタ商店" ? "/odd/en/brands/warota-shoten" :
                      product.brand === "Japanese Art Studio" ? "/odd/en/brands/japanese-art-studio" :
                      "/odd/en/brands"
                    }
